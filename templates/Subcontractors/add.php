    ...
    <div class="card text-center">
        ...
        <div class="card-body" style="width: 100%">
            <div class="row">
                ...
                <div class="col-6">
                    <?php
                    echo $this->Form->control('street',['class'=>'form-control','id'=>'current_address','placeholder'=>'Please Enter an address']);
                    echo $this->Form->control('city',['class'=>'form-control','id' => 'new_address','placeholder'=>'Please Enter a city']);
                    echo $this->Form->control('state',['class'=>'form-control','id' => 'new_state','placeholder'=>'Please Enter a state']);
                    echo $this->Form->control('postcode',['class'=>'form-control','id'=>'new_postcode','placeholder'=>'Please Enter a postcode','Maxlength'=>4]);
