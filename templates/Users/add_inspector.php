...
<div class="row">
    ...
    <div  class="card text-center">
        ...
        <div class="card-body">
            ...
            $options = array('Inspector' => 'Inspector');
        ...
        <div class="row">
            <div class="col-6">
                <?php
                echo $this->Form->control('inspector.first_name', ['class' => 'form-control', 'type' => 'word','placeholder'=>'First Name Here','Maxlength'=>20]);
                echo $this->Form->control('inspector.last_name', ['class' => 'form-control', 'type' => 'word','placeholder'=>'Last Name Here','Maxlength'=>20]);
                echo $this->Form->control('inspector.phone_no', ['class' => 'form-control', 'type' => 'number', 'maxlength' => 10,'placeholder'=>'Phone Number Here']);
                ?>
            </div>
            <div class="col-6">
                <?php
                echo $this->Form->control('inspector.street',['class'=>'form-control','id'=>'current_address','placeholder'=>'Enter an Address','Maxlength'=>50]);
                echo $this->Form->control('inspector.city',['class'=>'form-control','id' => 'new_address','placeholder'=>'Enter a City','Maxlength'=>50]);
                echo $this->Form->control('inspector.state',['class'=>'form-control','id' => 'new_state','placeholder'=>'Enter a State','Maxlength'=>50]);
                echo $this->Form->control('inspector.postcode',['class'=>'form-control','id'=>'new_postcode','placeholder'=>'Enter a Postcode','Maxlength'=>10]);
        ...
        <div class="row">
            <div class="col-12">
                <?php
                echo $this->Form->control('inspector.notes',['class'=>'form-control','Maxlength'=>3000,'placeholder'=>"The max word is 3000. If you have more want to talk, please email us. Our Email: info@48.com."]);
                ?>
            </div>
        </div>
