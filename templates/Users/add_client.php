...
<div class="row">
    ...
    <div  class="card text-center">
        ...
        <div class="card-body">
            <?php
            echo $this->Form->control('service_client.first_name',['class'=>'form-control', 'type' => 'word','placeholder'=>'First Name Here','Maxlength'=>50]);
            echo $this->Form->control('service_client.last_name',['class'=>'form-control', 'type' => 'word','placeholder'=>'Last Name Here','Maxlength'=>50]);
            echo $this->Form->control('service_client.phone_no',['class'=>'form-control','type' => 'number','maxlength'=>10,'placeholder'=>'Phone Number Here']);
            echo $this->Form->control('service_client.notes',['class'=>'form-control','Maxlength'=>3000,'placeholder'=>"The max word is 3000. If you have more want to talk, please email us. Our Email: info@48.com."]);
