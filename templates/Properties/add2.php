...
?>
<div class="row">
    <?= $this->Form->create($property,['style'=>'width:60%']) ?>
    <div class="card text-center">
        ...
        <div class="card-body" style="width: 100%">
            <div class="row">
                <div class="col-6">
                    <?php
                    echo $this->Form->control('client_name', ['readonly' => true, 'value' => $client->first_name . " " . $client->last_name, 'class' => 'form-control']);
                    ...
                    echo $this->Form->control('postcode', ['class' => 'form-control', 'type' => 'number', 'Maxlength' => '4', 'id' => 'new_postcode', 'placeholder' => 'Enter a Postcode', 'maxlength' => 10]);
                    ?>
                </div>
                <div class="col-6">
                    <?php
        ...
        <div class="card-footer text-muted">
            ...
            <?= $this->Form->end() ?>
            <?= $this->Html->link("Cancel", array('controller' => 'ServiceClients','action'=> 'Index', ), array( 'class' => 'btn btn-outline-secondary', 'type' =>'button'))?>
        </div>
    </div>
</div>
